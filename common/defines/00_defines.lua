...
NDiplomacy = {
	...
	BASE_STAGE_COUP_TOTAL_COST = 10000, 				-- Equipment consume factor for stage coup.
...
NMilitary = {
	...
	TRAINING_MAX_DAILY_COUNTRY_EXP = 0.1,			-- Maximum army XP gained per day from training
	...
	PLANNING_DECAY = 0,
	PLAYER_ORDER_PLANNING_DECAY = 0,				-- Amount of planning lost due to player manual order
	PLANNING_GAIN = 0.02,
